    ...
    <motion.div>
      ...
      >
        <g id="herobg" className="">
          <g id="background" >
            <motion.circle variants={opacity(2.85)} id="Ellipse 3" cx="550" cy="550" r="550" fill="#1F2434" fillOpacity="0.3" />
          ...
          <motion.g variants={slideLeft(2.4)} className="z-[1]" id="cloud2">
            <path
              id="Vector"
          ...
          <motion.g variants={slideLeft(2.1)} className=" z-[1]" id="cloud1">
            <path
              id="Vector_2"
