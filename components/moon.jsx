...
import { slideLeft, opacity } from "@/utils/motion";
...
const Moon = () => {
  return (
    <motion.div>
      ...
      >
        <g id="herobg" className="lg:inline hidden">
          <g id="background" >
            <motion.circle variants={opacity(1.35)} id="Ellipse 3" cx="550" cy="550" r="550" fill="#1F2434" fill-opacity="0.3" />
            <motion.circle variants={opacity(1.3)}
              id="Ellipse 4"
              cx="549.5"
              cy="550.5"
              r="487.5"
              fill="#383D4A" fill-opacity="0.3"
            />
            <motion.circle variants={opacity(1.25)}
              id="Ellipse 5"
              cx="550"
              cy="550"
              r="425"
              fill="#515561" fill-opacity="0.3"
            />
            <motion.circle variants={opacity(1.2)}
              id="Ellipse 6"
              cx="549.5"
              cy="550.5"
              r="362.5"
              fill="#6A6D77" fill-opacity="0.3"
            />
            <motion.circle variants={opacity(1.15)} id="Ellipse 7" cx="550" cy="550" r="300" fill="#83868E" fill-opacity="0.3" />
            <motion.circle variants={opacity(1.1)}
              id="Ellipse 8"
              cx="549.5"
              cy="550.5"
              r="237.5"
              fill="#9B9EA5" fill-opacity="0.3"
            />
          </g>
          <motion.g variants={slideLeft(0.85)} className="lg:inline hidden z-[1]" id="cloud2">
            <path
              id="Vector"
