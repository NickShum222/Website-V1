    ...
    <motion.div>
      ...
      >
        <g id="herobg" className="lg:inline hidden">
          <g id="background" >
            <motion.circle variants={opacity(1.2)} id="Ellipse 3" cx="550" cy="550" r="550" fill="#1F2434" fill-opacity="0.3" />
            ...
            />
            <motion.circle variants={opacity(0.9)}
              id="Ellipse 6"
              cx="549.5"
              cy="550.5"
              r="362.5"
            ...
            />
            <motion.circle variants={opacity(0.8)} id="Ellipse 7" cx="550" cy="550" r="300" fill="#83868E" fill-opacity="0.3" />
            <motion.circle variants={opacity(0.7)}
              id="Ellipse 8"
              cx="549.5"
              cy="550.5"
              r="237.5"
          ...
          <motion.g variants={slideLeft(0.5)} className="lg:inline hidden z-[1]" id="cloud2">
            <path
              id="Vector"
          ...
          <motion.g variants={slideLeft(0.6)} className="lg:inline hidden z-[1]" id="moon">
            <path
              id="moon_2"
          ...
          <motion.g variants={slideLeft(0.75)} className="lg:inline hidden z-[1]" id="cloud1">
            <path
              id="Vector_2"
