    ...
    <motion.div>
      ...
      >
        <g id="herobg" className="">
          <g id="background" >
            <motion.circle variants={opacity(2.65)} id="Ellipse 3" cx="550" cy="550" r="550" fill="#3c3c3c" fillOpacity="0.3" />
            ...
            />
            <motion.circle variants={opacity(2.55)}
              id="Ellipse 5"
              cx="550"
              cy="550"
              r="425"
            ...
            />
            <motion.circle variants={opacity(2.5)}
              id="Ellipse 6"
              cx="549.5"
              cy="550.5"
              r="362.5"
            ...
            />
            <motion.circle variants={opacity(2.45)} id="Ellipse 7" cx="550" cy="550" r="300" fill="#8a8a8a" fillOpacity="0.3" />
            <motion.circle variants={opacity(2.4)}
              id="Ellipse 8"
              cx="549.5"
              cy="550.5"
              r="237.5"
          ...
          <motion.g variants={slideLeft(2.2)} className="z-[1]" id="cloud2">
            <path
              id="Vector"
          ...
          <motion.g variants={slideLeft(2)} className=" z-[1]" id="moon">
            <path
              id="moon_2"
          ...
          <motion.g variants={slideLeft(2.15)} className=" z-[1]" id="cloud1">
            <path
              id="Vector_2"
