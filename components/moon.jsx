    ...
    <motion.div>
      ...
      >
        <g id="herobg" className="">
          ...
          <motion.g variants={slideLeft(0.85)} className="z-[1]" id="cloud2">
            <path
              id="Vector"
          ...
          <motion.g variants={slideLeft(0.5)} className=" z-[1]" id="moon">
            <path
              id="moon_2"
          ...
          <motion.g variants={slideLeft(0.6)} className=" z-[1]" id="cloud1">
            <path
              id="Vector_2"
