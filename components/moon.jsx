    ...
    <motion.div>
      ...
      >
        <g id="herobg" className="">
          <g id="background" >
            <motion.circle variants={opacity(2.35)} id="Ellipse 3" cx="550" cy="550" r="550" fill="#1F2434" fillOpacity="0.3" />
            <motion.circle variants={opacity(2.3)}
              id="Ellipse 4"
              cx="549.5"
              cy="550.5"
              r="487.5"
            ...
            />
            <motion.circle variants={opacity(2.25)}
              id="Ellipse 5"
              cx="550"
              cy="550"
              r="425"
            ...
            />
            <motion.circle variants={opacity(2.2)}
              id="Ellipse 6"
              cx="549.5"
              cy="550.5"
              r="362.5"
            ...
            />
            <motion.circle variants={opacity(2.15)} id="Ellipse 7" cx="550" cy="550" r="300" fill="#83868E" fillOpacity="0.3" />
            <motion.circle variants={opacity(2.1)}
              id="Ellipse 8"
              cx="549.5"
              cy="550.5"
              r="237.5"
          ...
          <motion.g variants={slideLeft(1.85)} className="z-[1]" id="cloud2">
            <path
              id="Vector"
          ...
          <motion.g variants={slideLeft(1.5)} className=" z-[1]" id="moon">
            <path
              id="moon_2"
          ...
          <motion.g variants={slideLeft(1.6)} className=" z-[1]" id="cloud1">
            <path
              id="Vector_2"
