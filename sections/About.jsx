...
const About = () => {
  return (
    <section className="xl:px-40 px-24 py-16 flex justify-center" id="about">
      <motion.div
        variants={staggerContainer}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: false, amount: 0.25 }}
        className="w-full flex lg:flex-row flex-col-reverse xl:justify-start justify-center items-center xl:items-start lg:gap-20"
      >
        <div className="relative">
          <motion.img
            ...
            src="/profile.jpg"
            alt="profile"
            className="shadow-lg rounded-[30px] lg:w-[100%] lg:max-w-[450px] w-[40%] object-contain  flex flex-1"
          />
          ...
          <RenderIfVisible
            ...
            stayRendered="true"
          >
            <Nick className="w-[50%] h-auto z-20" />
          </RenderIfVisible>
          </div>
        </div>
        <div className="flex flex-col justify-start lg:max-w-[50%]">
          <motion.h1 variants={slideRight(0.5)} className={styles.heading_2}>
            About
          </motion.h1>
          <motion.div
          ...
          >
            ...
            <p className={`${styles.paragraph}`}>
              I am very passionate about computer science and am always seeking
              opportunities to learn and grow which is why I constantly find
              myself learning new tools and technologies to hone my software
              development skills. When I’m not programming, I enjoy curating
              spotify playlists, going out with friends, or skateboarding when
              the weather is nice!
            </p>
