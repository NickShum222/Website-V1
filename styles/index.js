export const styles = {
  heading_2: 'text-[#FFFFFF] font-semibold font-poppins xl:text-[64px] lg:text-[56px] md:text-[48px] z-10 text-[40px]',
  ...
  paddings: 'xl:px-80 lg:px-[120px] md:px-36 px-6 py-24 flex flex-col justify-center z-[5] ',
