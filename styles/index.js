export const styles = {
  heading_2: 'text-[#BFBFBF] font-semibold font-poppins xl:text-[64px] lg:text-[56px] md:text-[48px] text-[35px]',
  ...
  paragraph: 'text-[#FFFFFF] font-poppins lg:text-[18px] md:text-[18px] text-[10] pb-3',
  paddings: 'xl:px-40 lg:px-[120px] px-24 py-24',
}
