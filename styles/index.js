export const styles = {
  heading_2: 'text-[#FFFFFF] font-normal font-poppins xl:text-[64px] lg:text-[56px] md:text-[48px] z-10 text-[40px]',
  ...
  label_form: 'pt-5 text-white font-poppins font-normal text-[18px]',
}
