export const styles = {
  ...
  paddings: 'xl:px-[170px] lg:px-[110px] md:px-36 px-6 md:py-24 py-12 flex flex-col justify-center z-[5] ',
  input_form: 'w-full p-3 outline-none text-[16px] text-semiwhite  bg-grey border-[1px] border-[#BFBFBF]  transition-all duration-300',
  new_input: "bg-transparent border-b py-2 outline-none w-full placeholder:text-{#BFBFBF} transition-all duration-150",
  label_form: 'pt-5 text-semiwhite font-poppins font-normal lg:text-[18px] text-[16px]',
}
